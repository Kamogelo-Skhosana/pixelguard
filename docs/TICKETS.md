...
- [ ] **P001** — Initialize repo: folder structure, `.gitignore`, `LICENSE` (MIT)
- [ ] **P002** — Set up Node/TypeScript project (`package.json`, `tsconfig.json`), document install in README
- [ ] **P003** — Add ESLint + Prettier config
- [ ] **P004** — Set up test framework scaffold (Vitest), `tests/` structure
- [ ] **P005** — Add GitHub Actions CI workflow: install deps, lint, test, build on push/PR

### Epic: Screenshot Capture
- [ ] **P006** — Add Playwright browser wrapper (`capture/browser.ts`) — launch, navigate, close
- [ ] **P007** — Implement full-page screenshot capture for a given URL
- [ ] **P008** — Implement capture across multiple viewport sizes (desktop/tablet/mobile)
...
- [ ] **P011** — Add config loading (target base URL, pages list, viewports, output dir)
